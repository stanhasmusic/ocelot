...
# Disposable single-entity boss prototype (one HP pool, a crude half-HP "phase"
# flip). PRD-12 replaces this as the canonical boss with the multi-part
# Boss + BossPart + BossState system; this script is kept only so the
# not-yet-migrated stage bosses (Boss.tscn, BossL2, BossL3) keep working until
# PRD-14 wires real bosses into stages. Do not build new bosses on this.
